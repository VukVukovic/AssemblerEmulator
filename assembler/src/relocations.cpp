...
const string Relocations::StringRelocationTypes[3] = {"R_386_8", "R_386_16",
                                                      "R_386_PC16"};

void Relocations::addRelocation(const string &section, RelocationType type,
                                const string &symbol, int offset) {
  relocations[section].push_back(RelEntry(type, symbol, offset));
}

void Relocations::printRelocaions(const string &section, ostream &out,
